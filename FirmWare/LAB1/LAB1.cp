#line 1 "D:/File hoc tap/GiaoTiepVaDieuKhienThietBiNgoaiVi_FirmWare/LAB1/LAB1.c"




unsigned char transmitData[ 12  + 1];
unsigned char receiveData[ 12  + 1];
unsigned char frameLocal[ 12  + 1];
unsigned char frameSW[ 12  + 1];
typedef enum{
 ON,
 OFF,
 NONE,
